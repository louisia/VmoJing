...
public class DragListView extends ListView implements OnScrollListener,
	...
	public void initHeadView(Context context) {
		mHeadView = LayoutInflater.from(context).inflate(R.layout.draglistview_head, null);
	...
	private void initLoadMoreView(Context context) {
		mFootView = LayoutInflater.from(context).inflate(R.layout.draglistview_footer, null);
